...
/** @addtogroup plugin-green-power-server Plugin Commands: Green Power Server
 * @ingroup cli
 * The Green Power Server plugin contributes CLI commands to the application
 * framework to be used for getting, setting, and displaying information
 * relevant to the Green Power Server cluster.
 * 
 * @{
 */

/** @brief <b>plugin green-power-server additionalInfoTable-clearAll </b>
 *   - <i>Clear all entries within the additionalInfoTable.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_GREEN_POWER_SERVER_PLUGIN_GREEN_POWER_SERVER_ADDITIONAL_INFO_TABLE_CLEAR_ALL

/** @brief <b>plugin green-power-server additionalInfoTable-clearEntry [index:1] </b>
 *   - <i>Clear  entry at index within the additionalInfoTable.</i>
...
/** @brief <b>plugin green-power-server additionalInfoTable-print </b>
 *   - <i>Print all entries of the additionalInfoTable.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_GREEN_POWER_SERVER_PLUGIN_GREEN_POWER_SERVER_ADDITIONAL_INFO_TABLE_PRINT

/** @brief <b>plugin green-power-server additionalInfoTable-setEntry [index:1] [gpdCommandId:1] [additionalInfoLength:1] [additionalInfoBlockIn:-1] </b>
 *   - <i>Set  entry at index within the additionalInfoTable.</i>
 *     - index - INT8U - index to additionalInfoBlock table
 *     - gpdCommandId - INT8U
...
/** @brief <b>plugin green-power-server commission [options:1] [gpmAddressSecurity:2] [gpmAddressPairing:2] [endpoint:1] </b>
 *   - <i>Put the GPS in commissioning mode</i>
...
/** @brief <b>plugin green-power-server cryptotest </b>
 *   - <i>Crypto test</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_GREEN_POWER_SERVER_PLUGIN_GREEN_POWER_SERVER_CRYPTOTEST

/** @brief <b>plugin green-power-server customizedTable-clearAll </b>
 *   - <i>Clear all entries within the customizedTable.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_GREEN_POWER_SERVER_PLUGIN_GREEN_POWER_SERVER_CUSTOMIZED_TABLE_CLEAR_ALL

/** @brief <b>plugin green-power-server customizedTable-clearEntry [index:1] </b>
 *   - <i>Clear  entry at index within the customizedTable.</i>
...
/** @brief <b>plugin green-power-server customizedTable-print </b>
 *   - <i>Print all entries of the customizedTable.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_GREEN_POWER_SERVER_PLUGIN_GREEN_POWER_SERVER_CUSTOMIZED_TABLE_PRINT

/** @brief <b>plugin green-power-server customizedTable-setEntry [index:1] [gpdCommandId:1] [zbEndpoint:1] [zigbeeProfile:2] [zigbeeCluster:2] [ServerOrClient:1] [zigbeeCommandId:2] [payloadLength:1] [zclPayloadsrc:1] [zclPayload:-1] </b>
 *   - <i>Set  entry at index within the customizedTable.</i>
 *     - index - INT8U - index to customized table
 *     - gpdCommandId - INT8U
...
/** @brief <b>plugin green-power-server sink-table-clear </b>
 *   - <i>Clear sink table.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_GREEN_POWER_SERVER_PLUGIN_GREEN_POWER_SERVER_SINK_TABLE_CLEAR

/** @brief <b>plugin green-power-server sink-table-print </b>
 *   - <i>Print all entries of the sink table.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_GREEN_POWER_SERVER_PLUGIN_GREEN_POWER_SERVER_SINK_TABLE_PRINT

/** @brief <b>plugin green-power-server table-clear </b>
 *   - <i>Clear all entries within the translation table.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_GREEN_POWER_SERVER_PLUGIN_GREEN_POWER_SERVER_TABLE_CLEAR

/** @brief <b>plugin green-power-server table-print </b>
 *   - <i>Print all entries of the translation table.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_GREEN_POWER_SERVER_PLUGIN_GREEN_POWER_SERVER_TABLE_PRINT

/** @brief <b>plugin green-power-server table-remove-endpoint [applicationId:1] [sourceId:4] [gpdIeeeAddr:8] [gpdEndpoint:1] [zbEndpoint:1] </b>
 *   - <i>remove Gpd  entry from the translation table for the specified endpoint.</i>
 *     - applicationId - INT8U
 *     - sourceId - INT32U
...
/** @brief <b>plugin green-power-server table-set [index:1] [options:2] [gpdIeeeAddr:8] [gpdEndpoint:1] [sourceId:4] [gpdCommandId:1] [zbEndpoint:1] [zigbeeProfile:2] [zigbeeCluster:2] [zigbeeCommandId:2] [payloadLength:1] [zclPayload:-1] [additionalInfoLength:1] [additionalInfoBlockIn:-1] </b>
 *   - <i>Set  entry at index within the translation table.</i>
...
/** @} */ // end group plugin-green-power-server
